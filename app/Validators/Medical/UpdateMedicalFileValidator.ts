...
const validation = {
  ...
  file: schema.file({ size: '2mb' })
}

export default class UpdateMedicalFileValidator {
   ...
   *    ```
   */
  public schema = schema.create(validation)

  public static props = schema.create(validation).props
